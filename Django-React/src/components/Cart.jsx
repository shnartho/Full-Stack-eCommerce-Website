...
const CartPage = () => {
    const [{ cartuncomplit: cartuncomplit }, dispatch] = useGlobalState()
    // console.log(cartuncomplit?.cartproduct);
    let cart_productt_length = 0;
    if (cartuncomplit !== null) {
        cart_productt_length = cartuncomplit?.cartproduct?.length
    } else {
        ...
        <div className="container p-3">
            ...
            <div className="row">
                ...
                </div>
                {
                    ...
                    <>
                        <div className="col">
                            <Link onClick={() => delatefullcard(cartuncomplit.id)} className="btn btn-danger" >Delate Card</Link>
                        </div>
                    </>
                }
            </div>
